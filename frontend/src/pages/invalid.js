    ...
    <div className={styles.container}>
      ...
      >
        ...
        <motion.p className={styles.features} variants={itemVariants}>
          Unlock your Personalized Dashboard, Evaluation Form, Screening Access, and Program details
        </motion.p>
        ...
        <motion.div className={styles.contact} variants={itemVariants}>
          <p>
            ...
            <a 
              ...
              onClick={(e) => {
                e.preventDefault();
                window.open('https://api.whatsapp.com/send?phone=917349222263', '_blank');
              }}
            >
              Connect now
            </a>
